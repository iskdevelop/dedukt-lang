package com.iskportal.dedukt.lang.sourcecode.body.declaration.axiom
...
data class AxiomDeclaration(
    override val identifier: String,
    override val typeOption: TypeOption?,
    override val context: AxiomDeclarationContext

): Declaration {
    override val declarationType: DeclarationType = DeclarationType.AXIOM
}
